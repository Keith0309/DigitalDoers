  ...
  <div className="form">
    <form onSubmit={handleSubmit}>
      <div className="input-container">
        ...
        <input placeholder=" email@youremail.com" type="text" name="uname" required />
      ...
      <div className="button-container">
        <button className="login-button fw-bold" type="submit">LOGIN</button>
      </div>
    </form>
        ...
        {/* <div className="col-md-12">
          ...
          <div className="signin-form mx-auto">
            <div className="login-form mx-auto" >
              ...
              <div className="signin-text text-center fw-bolder my-3">Sign in to your account</div>
              {isSubmitted ? <div className="text-center">User is successfully logged in!</div> : renderForm}
            </div>
          </div>
