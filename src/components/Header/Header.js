        ...
        <div className="container">
          ...
          <div>
            <button className="menu_button">
              <img className="menu_icon" src={burger_menu} alt="menu" draggable="false"></img>
          ...
          <div className="search_bar align-items-center">
            ...
            <button className="search_button"><img className="search_icon" src={search_icon} alt="search_icon" draggable="false"></img></button>
          </div>
          ...
          <div>
            <Link className="cart_button" to="/cart">
              <img className="cart_icon" src={cart_icon} alt="cart_icon" draggable="false"></img>
            </Link>
          </div>
        </div>
      </nav>
